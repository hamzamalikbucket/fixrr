...
class UserChatPartners extends StatefulWidget {
  final String userName;

  const UserChatPartners({super.key, required this.userName});

  @override
  State<UserChatPartners> createState() => _UserChatPartnersState();
}

class _UserChatPartnersState extends State<UserChatPartners> {
